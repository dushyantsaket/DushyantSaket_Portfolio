...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "dushyantsaket20@gmail.com",
    href: "mailto:dushyantsaket20@gmail.com",
    icon: <FaEnvelope height={"50px"} />,
  },
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/dushyant-choudhuary-aa20b52b2/",
    content: "/dushyant-choudhuary",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/dushyantsaket",
    content: "/dushyantsaket",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Dushyant SAKET</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Dushyant S. A. KET, a Full Stack Developer
              (B.Sc. CS, 2026) with internship experience in MERN stack, RESTful
              APIs, MongoDB, system design, and AI integration. I build scalable
              web platforms and AI-powered applications.
            </p>
            <p className="mb-10">
